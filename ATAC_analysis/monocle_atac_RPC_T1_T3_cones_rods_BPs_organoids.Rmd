---
title: "Monocle RPCs T1 T3 cones, rods, BPS - organoids"
output:
  html_document:
    df_print: paged
---
...
## RPC T1 T3 cones rods BP trajectory
...
The RPCs, T1 T3 cones rods BP cell types were selected and Monocle 3 pseudotime analysis performe starting from `r start_Node_ATAC`.  
...
all <- data.frame(motif = unique(c(pCM,
                                   earlyRPCs,
                                   lateRPCs,
                                   T1,
                                   T3,
